    ...
    <div className={classes.hero}>
      ...
      <Grid item xs={12} sm={7} className={classes.right}>
        ...
        <Grid item xs={12} sm={5} className={classes.left}>
          <div className={classes.leftText}>Brookfield School<span className={classes.span1}>A Great place to learn</span><a className={classes.span2} href="www.google.com">About Our School</a></div>
        </Grid>
      </Grid>
    </div>
  );
